...
class GetMoviesVerticalListView extends StatelessWidget {
  const GetMoviesVerticalListView({super.key, required this.movies, this.isDummy = false});
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) => DefaultDetailsMovieCardWidget(movieModel: movies[index], isDummy: isDummy,),
